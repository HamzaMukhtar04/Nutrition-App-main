...
import 'package:recipe/screen/sidebar_screens/tolearn/pages/home_page.dart';
     ...
     Drawer(
      child: ListView(
        ...
        children: [
          ...
          // ✅ ChatBot Option Added Below
              
              ListTile(
            leading: Icon(Icons.chat_bubble_outline),
            title: Text("Ask Nutrition Bot"),
            onTap: () {
              Navigator.of(context).pop(); // Close drawer
              Navigator.of(context).pushNamed('/chatbot'); // Navigate to chatbot
            },
          ),
